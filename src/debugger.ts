...
export default class console3 {
  ...
  public static getTimeFormatted(time?: number) {
    ...
    const minsLabel = mins > 0 ? mins.toString() : "0";
    const secsLabel = secs > 0 ? secs.toString() : "0";
    const millisLabel = Math.floor(millis * 1000).toString();
    const timeFormatted =
